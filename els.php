...
<font color = LIME face = Courier size = 2 ><b>Name: <?php echo $fullname ?></b></font><br>
    ...
    <!-- Table design -->
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="home.php" class="tdecor"><button class="button button1">BACK</button></a><br><br>
                ...
                <form action="score.php" method="post">
                    <?php for ($i = 0; $i < count($questions); $i++): ?>
                        ...
                        <?php foreach ($fake_answers[$i] as $index => $answer): ?>
                            ...
                            <input type="radio" name="q<?php echo $i; ?>" value="<?php echo $answer; ?>" required> <?php echo $letter; ?>. <?php echo $answer; ?><br>
                        <?php endforeach; ?>
                        <br>
                    <?php endfor; ?>
